...
std::string DaeRectLabel::ToString() const
{
	...
	output += "Label=" + helper + m_Label + helper + '\n';
	output += "TextColor=" + helper + std::to_string(m_TextCol.r) + ',' + std::to_string(m_TextCol.g) + ',' + std::to_string(m_TextCol.b) + ',' + std::to_string(m_TextCol.a) + helper + '\n';
	output += "/>\n\n";
