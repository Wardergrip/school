...
#pragma region MyAdditions
	...
	bool CheckInsideRect(float rectX, float rectY, float rectW, float rectH, float mouseX, float mouseY)
	{
	...
	bool CheckInsideRect(Point2f rectXY, float rectW, float rectH, Point2f mouseXY)
	{
		return CheckInsideRect(rectXY.x, rectXY.y, rectW, rectH, mouseXY.x, mouseXY.y);
	}
	bool CheckInsideRect(float rectX, float rectY, float rectW, float rectH, Point2f mouseXY)
	{
		return CheckInsideRect(rectX, rectY, rectW, rectH, mouseXY.x, mouseXY.y);
	}
	bool CheckInsideRect(Point2f rectXY, float rectW, float rectH, float mouseX, float mouseY)
	{
		return CheckInsideRect(rectXY.x, rectXY.y, rectW, rectH, mouseX, mouseY);
	}
